		 ...
		 void		 *userdata)
{
	...
	g_print ("set_func: %s\n", cmd);
        system(cmd);
	sleep (1);
	g_print ("set_func: /sbin/uci commit appcpus\n");
...
static int testcpus_reload(void)
{
...
int main(int argc, char *argv[])
{
	...
	CtSgwLog(LOG_NOTICE, "###appcpus test begin###\n");
        /****cpu value******/         
         while (running) {
		
	}
        CtSgwLog(LOG_NOTICE, "###appcpus test ending###\n");
        
        CtSgwLog(LOG_NOTICE, "appcpus Exiting\n");
