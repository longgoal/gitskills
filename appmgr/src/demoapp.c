...
int main(int argc, char *argv[])
{
	...
	//};
        ...
        //g_print("11111\n");
	CtSgwLogOpen(LOG_USER, "demoapp");   /* opt/upt/syslog.log */

	CtSgwLog(LOG_NOTICE, "start\n");

	CtSgwSetDbusEnv();
        //g_print("22222\n");
        g_print("######App_mgr Test is Beginning######\n");
        g_print("argv[1]=%s\n",argv[1]);
        start(argv[1]);  //call the test_appmgr.c file
        g_print("######App_mgr Test at Ending#########\n");
	//g_print("argv[1]=%s\n",argv[1]);	
        //g_print("333\n");
