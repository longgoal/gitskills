...
const function_entry_t FUCTION_MAP[NUMBER] = {
	...
	{ "CtSgwGetUpgradeStatus", CtSgwGetUpgradeStatus_NUM},
	{ "CtSgwSysCmdClearUpgradeStatus", CtSgwSysCmdClearUpgradeStatus_NUM},
	{ "CtSgwSetVPNConnection", CtSgwSetVPNConnection_NUM},
...
g_print("###################################################\n");
	...
	case CtSgwGetPONInfo_NUM:{
			...
			t_diff = end - start;
			   ...
			   target_param1.Voltage=atof(cJSON_GetObjectItem(CtSgwPONInfo, "Voltage")->valuestring);  
...
obj.ips = (CtSgwStrArray_t*)malloc(2 * sizeof(CtSgwStrArray_t));
	...
	case CtSgwAttachVPNConnection_NUM:{
				 ...
				 strcpy(ipAddrList,cJSON_GetObjectItem(in, "ipAddrList")->valuestring); 
                                 strcpy(macList,cJSON_GetObjectItem(in, "domainList")->valuestring);
                                 strcpy(macList,cJSON_GetObjectItem(in, "macList")->valuestring);  
				 //ipAddrNum=atoi(cJSON_GetObjectItem(in, "ipAddrNum")->valuestring); 
 			 double start,end,t_diff=0; struct timeval t_start,t_end,t_cont;
			 gettimeofday(&t_start,0);
			 start = (double)t_start.tv_sec * 1000 + (double)t_start.tv_usec / 1000;
 		    
				 return_value = CtSgwAttachVPNConnection(tunnelName, ipAddrList, domainList,macList);	
	...
	case CtSgwDetachVPNConnection_NUM:{
				 ...
				 strcpy(tunnelName,cJSON_GetObjectItem(in, "tunnelName")->valuestring); 
				 strcpy(ipAddrList,cJSON_GetObjectItem(in, "ipAddrList")->valuestring); 
				 strcpy(ipAddrList,cJSON_GetObjectItem(in, "domainList")->valuestring);
				 strcpy(ipAddrList,cJSON_GetObjectItem(in, "macList")->valuestring);
				 //ipAddrNum=atoi(cJSON_GetObjectItem(in, "ipAddrNum")->valuestring);  
			 ...
			 gettimeofday(&t_start,0);
			 start = (double)t_start.tv_sec * 1000 + (double)t_start.tv_usec / 1000;
				 return_value = CtSgwDetachVPNConnection(tunnelName, ipAddrList,domainList,macList);
...
CtSgwSetPlatformService_NUM:{
			...
			strcpy(obj.DistAddr,cJSON_GetObjectItem(in, "DistAddr")->valuestring);
                        ...
                        strcpy(obj.DistAddr,cJSON_GetObjectItem(in, "DistErrorMsg")->valuestring);
			strcpy(obj.OperAddr,cJSON_GetObjectItem(in, "OperAddr")->valuestring);
                        ...
                        strcpy(obj.DistAddr,cJSON_GetObjectItem(in, "OperErrorMsg")->valuestring);
                        ...
                        strcpy(obj.DistAddr,cJSON_GetObjectItem(in, "PluginErrorMsg")->valuestring);
                         double start,end,t_diff=0;
                         struct timeval t_start,t_end,t_cont;
			 gettimeofday(&t_start,0);
			 start = (double)t_start.tv_sec * 1000 + (double)t_start.tv_usec / 1000;
...
case CtSgwGetUpgradeStatus_NUM:{    
				CtSgwUpgradeStatus_t *obj;		    
		                 double start,end,t_diff=0;
		                 struct timeval t_start,t_end,t_cont;
				 gettimeofday(&t_start,0);
				 start = (double)t_start.tv_sec * 1000 + (double)t_start.tv_usec / 1000;
				 return_value = CtSgwGetUpgradeStatus(obj);
		                gettimeofday(&t_end,0);
				end = (double)t_end.tv_sec * 1000 + (double)t_end.tv_usec / 1000;
				t_diff = end - start;
				 if(FALSE == Check_return_result(return_value,atoi(return_target))) 
					 fill_capi_result("CtSgwGetUpgradeStatus","failed",return_value,t_diff); 
			         else
					 fill_capi_result("CtSgwGetUpgradeStatus","pass",return_value,t_diff); 
			 }
			 break;

case CtSgwSysCmdClearUpgradeStatus_NUM:{    
			        guint32 result=-1;
				gchar *errdesc=NULL;	    
		                 double start,end,t_diff=0;
		                 struct timeval t_start,t_end,t_cont;
				 gettimeofday(&t_start,0);
				 start = (double)t_start.tv_sec * 1000 + (double)t_start.tv_usec / 1000;
				 return_value = CtSgwSysCmdClearUpgradeStatus(&result, &errdesc);
		                gettimeofday(&t_end,0);
				end = (double)t_end.tv_sec * 1000 + (double)t_end.tv_usec / 1000;
				t_diff = end - start;
				 if(FALSE == Check_return_result(return_value,atoi(return_target))) 
					 fill_capi_result("CtSgwSysCmdClearUpgradeStatus","failed",return_value,t_diff); 
			         else
					 fill_capi_result("CtSgwSysCmdClearUpgradeStatus","pass",return_value,t_diff); 
			 }
			 break;


case CtSgwSetVPNConnection_NUM:{    
                              CtSgwVPNConn_t *obj; 
			      CtSgwObjPath_t path;
                              cJSON *in = cJSON_GetObjectItem(testcase,"in");
			      strcpy(path.str,cJSON_GetObjectItem(cJSON_GetObjectItem(in, "path"),"str")->valuestring);
				 ...
				 gettimeofday(&t_start,0);
				 start = (double)t_start.tv_sec * 1000 + (double)t_start.tv_usec / 1000;
				 return_value = CtSgwSetVPNConnection(path, obj);
		                gettimeofday(&t_end,0);
				end = (double)t_end.tv_sec * 1000 + (double)t_end.tv_usec / 1000;
				t_diff = end - start;
				 if(FALSE == Check_return_result(return_value,atoi(return_target))) 
					 fill_capi_result("CtSgwSetVPNConnection","failed",return_value,t_diff); 
			         else
					 fill_capi_result("CtSgwSetVPNConnection","pass",return_value,t_diff); 
			 }
			 break;
